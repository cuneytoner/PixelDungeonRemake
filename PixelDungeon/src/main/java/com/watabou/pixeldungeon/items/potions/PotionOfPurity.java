...
public class PotionOfPurity extends Potion {
	...
	protected void moistenTaintedDrink(TaintedDrink rdrink) {

		detachMoistenItems(rdrink,1);
		moistenEffective();
		GLog.i(TXT_ROTTEN_FOOD_MOISTEN, rdrink.name());

		getCurUser().collect(rdrink.purify());
	}
}
