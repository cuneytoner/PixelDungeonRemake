...
public class DragonPitsBossLevel extends Level {
    ...
    public String tileDesc( int tile ) {
        switch (tile) {
            case Terrain.ENTRANCE:
                return Game.getVar(R.string.Dragon_Pits_TileDescEntrance);
            case Terrain.EXIT:
                return Game.getVar(R.string.Dragon_Pits_TileDescExit);
            case Terrain.HIGH_GRASS:
                return Game.getVar(R.string.Dragon_Pits_TileHighGrass);
            case Terrain.WALL_DECO:
                return Game.getVar(R.string.Dragon_Pits_TileDescDeco);
            default:
